import { b as useId, h as useEventBus } from './Pagination-C8PXYeA9.mjs';
import { defineComponent, toRef, inject, computed, ref, provide, useSSRContext, onUnmounted, mergeProps } from 'vue';
...
const _sfc_main$1 = defineComponent({
  ...
  setup(props) {
    ...
    const inputId = ref(useId("$5DqOZn4Anw"));
    provide("form-group", {
      error,
      inputId,
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.14.1_nuxt@3.10.3_vite@5.1.4_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/forms/FormGroup.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.14.1_nuxt@3.10.3_vite@5.1.4_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/forms/Form.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { __nuxt_component_2 as _, __nuxt_component_1 as a };
//# sourceMappingURL=Form-D0_i0rpr.mjs.map
